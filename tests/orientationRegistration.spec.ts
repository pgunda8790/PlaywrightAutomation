...
import {validateSessions,validateEmergencyContact,cancellationPageFieldsVisibilityCheck,cancellationConfirmation} from '../utils/registrationHelpers';
...
{
await loginSF(page);
const attendeeFound = await verifyAttendee(page, registerData.eventName);
